...
-- Equation(s):
-- \inst4~1_combout\ = (\input0[3]~input_o\ & (\input1[3]~input_o\ & (\input1[2]~input_o\ $ (!\input0[2]~input_o\)))) # (!\input0[3]~input_o\ & (!\input1[3]~input_o\ & (\input1[2]~input_o\ $ (!\input0[2]~input_o\))))
...
-- Equation(s):
-- \inst4~0_combout\ = (\input1[1]~input_o\ & (\input0[1]~input_o\ & (\input0[0]~input_o\ $ (!\input1[0]~input_o\)))) # (!\input1[1]~input_o\ & (!\input0[1]~input_o\ & (\input0[0]~input_o\ $ (!\input1[0]~input_o\))))
