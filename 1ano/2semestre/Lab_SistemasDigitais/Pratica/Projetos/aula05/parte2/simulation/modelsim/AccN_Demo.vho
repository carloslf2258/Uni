...
-- Equation(s):
-- \inst|RegN|dataOut[1]~10_combout\ = (\SW[1]~input_o\ & ((\inst|RegN|dataOut\(1) & (\inst|RegN|dataOut[0]~9\ & VCC)) # (!\inst|RegN|dataOut\(1) & (!\inst|RegN|dataOut[0]~9\)))) # (!\SW[1]~input_o\ & ((\inst|RegN|dataOut\(1) & (!\inst|RegN|dataOut[0]~9\)) # 
-- (!\inst|RegN|dataOut\(1) & ((\inst|RegN|dataOut[0]~9\) # (GND)))))
-- \inst|RegN|dataOut[1]~11\ = CARRY((\SW[1]~input_o\ & (!\inst|RegN|dataOut\(1) & !\inst|RegN|dataOut[0]~9\)) # (!\SW[1]~input_o\ & ((!\inst|RegN|dataOut[0]~9\) # (!\inst|RegN|dataOut\(1)))))
