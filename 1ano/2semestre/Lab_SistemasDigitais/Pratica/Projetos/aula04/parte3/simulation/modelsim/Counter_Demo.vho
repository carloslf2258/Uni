...
SIGNAL \decoder|decOut_n[6]~2_combout\ : std_logic;
SIGNAL \decoder|decOut_n[6]~17_combout\ : std_logic;
...
SIGNAL \decoder|decOut_n[3]~5_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \decoder|decOut_n[6]~17_combout\,
	devoe => ww_devoe,
	o => \HEX0[6]~output_o\);
...
\decoder|decOut_n[6]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \decoder|decOut_n[6]~2_combout\ = (\inst|s_count\(0) & (!\inst|s_count\(3) & (\inst|s_count\(1) $ (!\inst|s_count\(2))))) # (!\inst|s_count\(0) & (!\inst|s_count\(1) & (\inst|s_count\(2) $ (!\inst|s_count\(3)))))
...
PORT MAP (
	...
	datac => \inst|s_count\(0),
	datad => \inst|s_count\(3),
	combout => \decoder|decOut_n[6]~2_combout\);

-- Location: LCCOMB_X114_Y44_N4
\decoder|decOut_n[6]~17\ : cycloneive_lcell_comb
-- Equation(s):
-- \decoder|decOut_n[6]~17_combout\ = (\decoder|decOut_n[6]~2_combout\) # (!\SW[2]~input_o\)
...
PORT MAP (
	datac => \SW[2]~input_o\,
	datad => \decoder|decOut_n[6]~2_combout\,
	combout => \decoder|decOut_n[6]~17_combout\);

-- Location: LCCOMB_X114_Y40_N10
\decoder|decOut_n~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \decoder|decOut_n~6_combout\ = (\inst|s_count\(1) & (!\inst|s_count\(3) & ((\inst|s_count\(0)) # (!\inst|s_count\(2))))) # (!\inst|s_count\(1) & (\inst|s_count\(0) & (\inst|s_count\(2) $ (!\inst|s_count\(3)))))
...
-- Equation(s):
-- \decoder|decOut_n~7_combout\ = (\decoder|decOut_n~6_combout\) # (!\SW[2]~input_o\)
...
-- Equation(s):
-- \decoder|decOut_n~8_combout\ = (\inst|s_count\(1) & (((\inst|s_count\(0) & !\inst|s_count\(3))))) # (!\inst|s_count\(1) & ((\inst|s_count\(2) & ((!\inst|s_count\(3)))) # (!\inst|s_count\(2) & (\inst|s_count\(0)))))
...
-- Equation(s):
-- \decoder|decOut_n~9_combout\ = (\decoder|decOut_n~8_combout\) # (!\SW[2]~input_o\)
...
\decoder|decOut_n[3]~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \decoder|decOut_n[3]~5_combout\ = (\inst|s_count\(1) & ((\inst|s_count\(2) & (\inst|s_count\(0))) # (!\inst|s_count\(2) & (!\inst|s_count\(0) & \inst|s_count\(3))))) # (!\inst|s_count\(1) & (!\inst|s_count\(3) & (\inst|s_count\(2) $ (\inst|s_count\(0)))))
...
PORT MAP (
	...
	datac => \inst|s_count\(0),
	datad => \inst|s_count\(3),
	combout => \decoder|decOut_n[3]~5_combout\);

-- Location: LCCOMB_X114_Y44_N2
\decoder|decOut_n[3]~18\ : cycloneive_lcell_comb
-- Equation(s):
-- \decoder|decOut_n[3]~18_combout\ = (\decoder|decOut_n[3]~5_combout\) # (!\SW[2]~input_o\)
...
PORT MAP (
	datac => \SW[2]~input_o\,
	datad => \decoder|decOut_n[3]~5_combout\,
	combout => \decoder|decOut_n[3]~18_combout\);

-- Location: LCCOMB_X114_Y40_N4
\decoder|decOut_n~11\ : cycloneive_lcell_comb
-- Equation(s):
-- \decoder|decOut_n~11_combout\ = (\inst|s_count\(2) & (\inst|s_count\(3) & ((\inst|s_count\(1)) # (!\inst|s_count\(0)))))
...
-- Equation(s):
-- \decoder|decOut_n~10_combout\ = (\inst|s_count\(1) & (!\inst|s_count\(2) & (!\inst|s_count\(0) & !\inst|s_count\(3))))
...
-- Equation(s):
-- \decoder|decOut_n~12_combout\ = (\decoder|decOut_n~11_combout\) # ((\decoder|decOut_n~10_combout\) # (!\SW[2]~input_o\))
...
PORT MAP (
	...
	datac => \decoder|decOut_n~10_combout\,
	datad => \SW[2]~input_o\,
...
-- Equation(s):
-- \decoder|decOut_n~13_combout\ = (\inst|s_count\(2) & (!\inst|s_count\(3) & (\inst|s_count\(1) $ (\inst|s_count\(0))))) # (!\inst|s_count\(2) & (\inst|s_count\(1) & (\inst|s_count\(0) & \inst|s_count\(3))))
...
-- Equation(s):
-- \decoder|decOut_n~14_combout\ = ((\decoder|decOut_n~11_combout\) # (\decoder|decOut_n~13_combout\)) # (!\SW[2]~input_o\)
...
-- Equation(s):
-- \decoder|decOut_n~15_combout\ = (\inst|s_count\(2) & (!\inst|s_count\(1) & (\inst|s_count\(0) $ (!\inst|s_count\(3))))) # (!\inst|s_count\(2) & (\inst|s_count\(0) & (\inst|s_count\(1) $ (!\inst|s_count\(3)))))
...
-- Equation(s):
-- \decoder|decOut_n~16_combout\ = (\decoder|decOut_n~15_combout\) # (!\SW[2]~input_o\)
