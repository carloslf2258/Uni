...
unsigned int f2(unsigned int n) { // n^(2) / 2
  unsigned int r = 0;
  for (unsigned int i = 1; i <= n; i++) {
...
unsigned int f3(unsigned int n) { // n^(2)
  unsigned int r = 0;
  for (unsigned int i = 1; i <= n; i++) {
...
unsigned int f4(unsigned int n) { // n^(3) / 3
  unsigned int r = 0;
  for (unsigned int i = 1; i <= n; i++) {
...
unsigned int f5(unsigned int n) { // n^(3)
  unsigned int r = 0;
  for (unsigned int i = 1; i <= n; i++) {
    for (unsigned int j = 1; j <= n; j++) {
...
unsigned int f6(unsigned int n) { //log2(n)
  unsigned int r = 0;
...
unsigned int f7(unsigned int n) { //Crescimento exponencial
  unsigned int r = 0;
  unsigned int last = 1;
  for (unsigned int i = 1; i <= n; i++) {
